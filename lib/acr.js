...
exports.FIRSTRUN_LANDING_PAGE = "https://%%AMO_HOST%%/pages/compatibility_firstrun".
    replace("%%AMO_HOST%%", prefService.get("extensions.acr.amo_host"));
exports.FIRSTRUN_LANDING_PAGE_TB = "https://%%AMO_HOST%%/thunderbird/pages/compatibility_firstrun".
    replace("%%AMO_HOST%%", prefService.get("extensions.acr.amo_host"));
