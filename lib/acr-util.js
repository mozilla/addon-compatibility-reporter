...
Version.prototype.toJSON = function() this.version;
Version.prototype.toString = function() this.version;
Version.prototype.valueOf = function() this.version;
Version.prototype.compare = function(val) Services.vc.compare(this.version, val);
...
exports.getHostEnvironmentInfo = function()
{
    ...
    var hostEnvInfo =
    {
        ...
        appGUID: info.ID,
        appName: info.name,
        appVersion: new Version(info.version),
